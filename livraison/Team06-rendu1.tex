...
\paragraph{}
La classe Livre représente une édition de livre alors qu'un exemplaire est un livre physique présent dans la bibliothèque. Cette relation est representée comme une association entre la classe Livre et la classe Exemplaire de livre. Un exemplaire n'est relié qu'à un seul livre mais un livre est relié à plusieurs exemplaires. Nous disposons d'un attribut calculé au sein du livre afin de connaitre le nombre d'exemplaires de ce livre présent dans la bibliothèque. La cote d'un exemplaire est representée par le numéro de document dont Exemplaire de livre hérite. Les détails concernant l'emprunt et  la réservation se retrouvent dans les classes d'associations Emprunt et Réservation.La perte se retrouve directement au sein de l'exemplaire. La méthode est_disponible() de la classe exemplaire prend en considération les réservations, l'emprunt et la perte de l'exemplaire du livre.
